	...
	protected void doPost(HttpServletRequest request,HttpServletResponse response) 
		...
		try {
			...
			while(rs.next()){
				...
				ebook.setId(rs.getInt(8));
				ebooks.add(ebook);
			}
			result = "ebookfree_table.jsp";
		} catch (Exception e) {
			e.printStackTrace();
			result = "error.jsp";
		} finally {
