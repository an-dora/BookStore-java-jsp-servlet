...
<head>
<base href="<%=basePath%>">
<title>Quản lý người dùng-Quản lý hiệu sách</title>
...
<jsp:include page="top.jsp"/> 
		<div class="row">
				<ul class="breadcrumb">
					<li class="active"><i class="icon-align-justify"></i> Danh sách người dùng</li>
				</ul>
				<div style="min-height:400px;">
					<c:import url="/manageuser_table"/>
				</div>
		</div>
...
$(function(){
	$('.button-book-delete').click(function(){
		...
		var result = confirm('Bạn có chắc chắn muốn xóa người dùng này');
		if(result){
